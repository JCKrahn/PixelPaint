...
eng = {
    ...
    "help": "&Help",
    "get help online": "open in Browser (online version)",
    "get help offline": "open in Browser (offline version)",
    "tools": "Tools",
    "draw": "Draw",
...
ger = {
    ...
    "image maxsize warning": "Das Deaktivieren der maximalen Bildgröße \nkann zu Performanceproblemen und Abstürzen "
                             "führen.",
    "help": "&Hilfe",
    "get help online": "öffnen im Browser (online Version)",
    "get help offline": "öffnen im Browser (offline Version)",
    "tools": "Werkzeuge",
    "draw": "Zeichnen",
